            ...
            <form action="gallery" method="POST" enctype="multipart/form-data">
                ...
                <div class="p-6 space-y-6 overflow-y-auto max-h-[570px]">
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama_foto" class="p-2 rounded border-2 border-black w-96">
                    </div>
                    <div class="font-medium mb-4">
                        <p class="mb-2">Tanggal Posting</p>
                        <input type="date" name="tanggal_posting" class="p-2 rounded border-2 border-black w-96">
                    </div>
                    <div class="mb-3">
                        <label
                          for="formFile"
