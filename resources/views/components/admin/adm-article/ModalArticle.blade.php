            ...
            <form action="article" method="POST" enctype="multipart/form-data">
                ...
                <div class="p-6 space-y-6 overflow-y-auto max-h-[570px]">
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama_article" class="p-2 rounded border-2 border-black w-96">
                    </div>
                    <div class="mb-4">
                        <p class="font-medium">Deskripsi article</p>
                        <textarea type="text" name="deskripsi_article" class="p-2 rounded border-2 border-black w-9/12"> </textarea>
                    </div>
                    <div class="font-medium mb-4">
                        <p class="mb-2">Isi article</p>
                        <textarea id="myeditorinstance" name="isi_article" type="text" class="p-2 rounded border-2"> </textarea>
                    </div>
                    <div class="font-medium mb-4">
                        <p class="mb-2">Kategori article</p>
                        <input type="text" name="kategori_article" class="p-2 rounded border-2 border-black w-96">
                    </div>
                    <div class="font-medium mb-4">
                        <p class="mb-2">Daftar Pustaka</p>
                        <textarea id="myeditorinstance" name="dafpus_article" type="text" class="p-2 rounded border-2"> </textarea>
                    </div>
                    <div class="font-medium mb-4">
                        <p class="mb-2">url_article</p>
                        <input type="url" name="url_article" class="p-2 rounded border-2 border-black w-96">
                    </div>
                    <div>
