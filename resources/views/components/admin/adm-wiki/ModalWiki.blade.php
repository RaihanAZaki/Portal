            ...
            <form action="wiki" method="POST" enctype="multipart/form-data">
                ...
                <div class="p-6 space-y-6 overflow-y-auto max-h-[570px]">
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama_wiki" class="p-2 rounded border-2 border-black w-96">
                    </div>
                    <div class="mb-4">
                        <p class="font-medium">Deskripsi wiki</p>
                        <textarea type="text" name="deskripsi_wiki" class="p-2 rounded border-2 border-black w-9/12"> </textarea>
                    </div>
                    <div class="font-medium mb-4">
                        <p class="mb-2">Isi wiki</p>
                        <textarea id="myeditorinstance" name="isi_wiki" type="text" class="p-2 rounded border-2"> </textarea>
                    </div>
                    <div class="font-medium mb-4">
                        <p class="mb-2">URL WIKI</p>
                        <input type="url" name="url_wiki" class="p-2 rounded border-2 border-black w-96">
                    </div>
                    <div>
