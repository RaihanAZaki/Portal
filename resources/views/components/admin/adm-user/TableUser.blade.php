            ...
            <form action="user/{{$data -> id}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="p-6 space-y-6 overflow-y-auto max-h-[570px]">
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" value="{{$data->name}}" class="p-2 rounded border-2 border-black mb-2 w-96">
                    </div>
                    <div class="font-medium mb-4">
                        <p class="mb-2">Email User</p>
                        <input type="text" name="email" class="p-2 rounded border-2 border-black w-96" value="{{$data->email}}">
                    </div>
                    <div class="font-medium mb-4">
                        <p class="mb-2">Password User</p>
                        <input type="text" name="password" class="p-2 rounded border-2 border-black w-96" value="{{$data->password}}">
                    </div>
                </div>
