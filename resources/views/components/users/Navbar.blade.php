        ...
        <div class="relative flex h-16 items-center justify-between">
            <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                <div class="flex flex-shrink-0 items-center">
                    <img class="h-10 w-auto" src="../MPPA.png" alt="Your Company">
                </div>
                <div class="hidden sm:ml-6 sm:block">
                    <div class="flex space-x-4">
                        <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                        <a href="/" class=" text-gray-900 hover:bg-[#B52544] hover:text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Home</a>
                        <a href="/announcement" class="text-gray-900 hover:bg-[#B52544] hover:text-white rounded-md px-3 py-2 text-sm font-medium">Announcement</a>
                        <a href="/article" class="text-gray-900 hover:bg-[#B52544] hover:text-white rounded-md px-3 py-2 text-sm font-medium">Article</a>
                        <a href="/wiki" class="text-gray-900 hover:bg-[#B52544] hover:text-white rounded-md px-3 py-2 text-sm font-medium">Wiki</a>
                        <a href="/contact" class="text-gray-900 hover:bg-[#B52544] hover:text-white rounded-md px-3 py-2 text-sm font-medium">Contact</a>
                    </div>
                </div>
            </div>
            <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                <button type="button" class="relative rounded-full bg-[#B52544] p-1 text-white hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" data-modal-target="authentication-modal" data-modal-toggle="authentication-modal">
