...
<body>
        ...
        <div class="flex justify-center mt-10 mb-10">
            <div class="w-full md:w-4/5">   
                ...
                @if (session('logout'))
                <div id="logoutMessage" class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative mb-5" role="alert">
                        ...
                        <ol class="relative border-l border-gray-200 ">           
                            @forelse ($menu as $data)
                                <li class="mb-6 ml-3">            
                                    ...
                                    <a href="{{$data -> url_menu}}" target="_blank" class="flex items-center mb-1 text-md font-semibold text-gray-900 ml-8 hover:underline ">
                                        {{$data -> nama_menu}}
                            ...
                            @empty
                            <li class="mb-6 ml-6">            
                                <span class="absolute flex items-center justify-center w-5 h-5 mt-1 bg-blue-100 rounded-full ring-black  dark:bg-blue-900">
        ...
        <script>
            ...
            closeButton.addEventListener('click', closeFailedMessage);
            
            // Menutup pesan sukses secara otomatis setelah 5 detik
            setTimeout(closeFailedMessage, 5000); // Ubah angka 5000 sesuai dengan yang Anda inginkan
            ...
            closeButton.addEventListener('click', closeLogoutMessage);
            
            // Menutup pesan sukses secara otomatis setelah 5 detik
            setTimeout(closeLogoutMessage, 5000); // Ubah angka 5000 sesuai dengan yang Anda inginkan
            ...
            closeButton.addEventListener('click', closeSessionMessage);
            
            // Menutup pesan sukses secara otomatis setelah 5 detik
            setTimeout(closeSessionMessage, 5000); // Ubah angka 5000 sesuai dengan yang Anda inginkan
        </script>
</body>
</html>